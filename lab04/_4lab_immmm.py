...
ax1.hist(lcg_nums, bins=100, density=True, alpha=0.7, label='LCG', color='red', edgecolor='black')
ax1.hist(rand_nums, bins=100, density=True, alpha=0.7, label='random', color='green', edgecolor='black')
